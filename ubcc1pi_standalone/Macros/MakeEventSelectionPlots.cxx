...
int MakeEventSelectionPlots(const std::string &overlayFileName, const bool drawErrors = false, const bool useAbsPdg = true)
{
    // Get the selection
    ...
    // Set up the plots
    auto plot_nuEnergy = PlottingHelper::EfficiencyPlot("True neutrino energy / GeV", 40u, 0.f, 2.5f, allCuts, drawErrors);
    ...
    for (unsigned int i = 0; i < nEvents; ++i)
    {
        ...
        const auto isSelected = selection.Execute(pEvent, cutsPassed);
