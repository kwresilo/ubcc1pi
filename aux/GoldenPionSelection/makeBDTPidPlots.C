...
int makeBDTPidPlots()
{
    ...
    const std::string pionGString = "truePdgCode == 211 && trueIsGolden";
    const std::string pionNGString = "truePdgCode == 211 && !trueIsGolden";
    const std::string muonString = "truePdgCode == 13";
    const std::string protonString = "truePdgCode == 2212";
